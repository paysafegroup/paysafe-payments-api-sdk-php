...
/**
 * These are the details of the pagoefectivo account used for the request.
 * Only one payment instrument object (for example, card or pagoefectivo)
 * can be included in the request.
 */
class Pagoefectivo extends BaseModel
{
	...
	{
		return "class Pagoefectivo {" . PHP_EOL
