 ...
 */
class Paysafecash extends BaseModel
{

	/**
	 * This is the merchant's unique identifier of the customer.
     * For security purposes, if any personal data is used
     * (for example, customer's user name, email address, etc.), it has to be encrypted or hashed.
	...
	/**
	 * This is barcode expiration time in minutes at Paysafecash end.
	 * Example: 10
	 */
	 ...
	 * @return Paysafecash
	 */
	public function expirationTime(int $expirationTime): self
	{
	...
	/**
	 * Getter function for expirationTime
	 * 
	 * @return int
	 */
	...
	{
		return "class Paysafecash {" . PHP_EOL . 
