...
/**
 * Map of cardBrand and card type for CardType config. <br />
 * Possible Values for the CardBrand are:   <br />
 * • VI - Visa  <br />
 * • MC - MasterCard  <br />
 * • DI - Discover  <br />
 ...
 * • MD - Maestro  <br />
 * <br />
 * Possible values for the CardType are:  <br />
 * • CREDIT  <br />
 * • DEBIT   <br />
 * • BOTH   <br />
 * • PREPAID   <br />
 * • DEFERREDDEBIT  <br />
 */
class CardTypeConfig extends BaseModel
{
	...
	{
		return "class CardTypeConfig {" . PHP_EOL
