 ...
 */
class StandaloneCreditRequest extends BaseModel
{
	 ...
	 * must match the amount specified in the Payment Handle request
	 ...
	 * A duplicate request is when the merchantRefNum has already been used in
	...
	/**
	 * The sender is deemed to be the person or party who has the contractual relationship with
     * the end customer.<br />
	...
	{
		return "class StandaloneCreditRequest {" . PHP_EOL
